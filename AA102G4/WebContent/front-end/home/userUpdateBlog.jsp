				...
				<div class="container">
					<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/blog/blog.do" name="form1" enctype="multipart/form-data">
						<table style="margin: 3% auto;">
							...
							<tr>
								<td>標題:</td>
								<td><input type="TEXT" name="blog_title" size="28.5" value="${(blogVO==null)? '':blogVO.blog_title}" placeholder="Title"/></td>
							</tr>
							<tr>
								<td>內容:</td>
								<td>
									<form id="content" method="post">
										...
										<textarea class="ckeditor" id="content" rows="7" cols="50" name="blog_content" placeholder="Content"><%=(blogVO == null) ? "" : blogVO.getBlog_content()%></textarea>
									</form>
								</td>
							</tr>
							<tr>
