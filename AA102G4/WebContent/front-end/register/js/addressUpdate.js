...
function init_address(){
    ...
    zone1.options.add(first1());
    zone2.options.add(first2());
    var adds = ["",""];
    if(addressUpdate.value!=""){
    	adds = addressUpdate.value.split("-");
    }
    //市
	for(var i in zip[0]){
	...
	zone1.onchange=function(){
	   ...
	   addressUpdate.value = zone1.value+"-";
       if(zone1.value==""){
    	   addressUpdate.value = "";
	   }
		zone2.innerHTML='';
	...
	zone2.onchange=function(){
		addressUpdate.value = zone1.value+"-"+zone2.value;
	}
