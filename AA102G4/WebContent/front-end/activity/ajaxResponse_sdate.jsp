...
<% 
	...
	ResultSet rs = stmt.executeQuery("select count(1) as cnt from activity where to_date('"+s_date+
    ...
    rs = stmt.executeQuery("select count(1) as cnt from "+
            ...
            " where ja.act_no=a.act_no and ja.mem_no="+mem_no+") where to_date('"+s_date+
