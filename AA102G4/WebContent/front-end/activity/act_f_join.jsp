	...
	$(function(){
		...
		$("input[id^='bt']").bind("click",function(){
			...
			if(idAry[0]=="bt1"){
				...
				$("#form1").attr("action","<%=request.getContextPath()%>/activity/activity.do");
				$("#form1_action").val("getOne_For_Update2");
			}else{
				$("#form1").attr("action","<%=request.getContextPath()%>/activity/activity.do");
				$("#form1_action").val("getOne_For_Update3");
			}
			$("#form1").submit();
		})
	})
						...
						<div class="thumbnail aaa box">
							...
							<div class="caption">
								...
								<p class="txtlim">
									...
									<input type="button" id="bt2_${actVO.act_no}" value="檢舉" class="btn btn-default">
									<input type="button" id="bt3_${actVO.act_no}" value="查詢" class="btn btn-default">	  						
							</div>
						</div>
					</div>
