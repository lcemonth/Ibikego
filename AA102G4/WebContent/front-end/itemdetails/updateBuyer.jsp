...
<c:if test="${not empty errorMsgs}">
	...
	<div class="container">
			...
			<a href="<%=request.getContextPath()%>/itemdetails.do?action=allitemdetails">All</a>
				<form class="form-horizontal" METHOD="post" ACTION="<%=request.getContextPath()%>/itemdetails.do?action=update_Buyer" name="form1">
				<div class="form-group">
				<tr>
					<th>買家分數:</th>
					<td><input type="radio" name="item_buyer_score" value="60"/>差
