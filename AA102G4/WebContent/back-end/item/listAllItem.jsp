...
<c:if test="${not empty errorMsgs}">
	...
	<ul>
		...
		<div class="row">
			<div class="col-sm-12">
			<h1>商品管理<small>查詢All</small></h1>
			<form class="form-horizontal" METHOD="post" ACTION="<%=request.getContextPath()%>/item.do?action=getOne_For_Display">
			<div class="col-sm-6">
			<div class="col-sm-3"><b valign="middle">輸入商品編號:</b></div>
			<div class="col-sm-3"><input type="text" class="form-control" name="item_no"></input></div>
			<input type="submit" class="btn btn-primary" value="送出">
			</div>
			</form>
			<form class="form-horizontal" METHOD="post" ACTION="<%=request.getContextPath()%>/item.do?action=getOneMem">
			<div class="col-sm-6">
			<div class="col-sm-3"><b valign="middle">選擇會員編號:</b></div>
			<div class="col-sm-3">
...
<table class="table table-hover table-bordered table-condensed" >
	...
	<c:if test="${itemVO.item_is_added==1}">
