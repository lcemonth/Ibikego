...
// 				List<ForumVO> list = forumSvc.mem_getAll();
// 				pageContext.setAttribute("list",list);
			...
			<li>		
					<form METHOD="post" ACTION="<%=request.getContextPath()%>/forum.do?action=select_title" class="navbar-form navbar-left" role="search">
						<div class="form-group">
							<b>標題:</b> <input type="text" class="form-control" name="forum_title" placeholder="請輸入關鍵字">
						</div>
						<button type="submit" class="btn btn-primary">搜尋</button>
						<input type="hidden" name="action" value="select_title">
					</form>
			</li>
