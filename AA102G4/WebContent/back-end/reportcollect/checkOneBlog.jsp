...
<html >
	...
	<body>
		...
		<div id="dialogcnt" title="日誌內容" style="display:none">
			<p>${blogVO.blog_content}</p>
		</div>	
		<div class="row">
								...
								<td>${blogVO.blog_no}</td>
									<td>
										<c:forEach var="memVO" items="${memSvc.all}">
						                    <c:if test="${blogVO.mem_no==memVO.mem_no}">
						            ...
						            <td id="blogcnt">
						                <div class="txtbox">
											<p class="ellipsis"> <font>${blogVO.blog_content}</font ></p>
										</div>
						            </td> 
