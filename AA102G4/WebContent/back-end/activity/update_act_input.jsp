...
<%
   ...
   Integer mem_no=actVO.getMem_no();
		...
		<div class="col-xs-9 col-md-10 col-sm-10">
					<div class="container">
						...
						<h1>
							...
							<table border='1' cellpadding='5' cellspacing='0' width='824'>
				...
				<table class="table table-bordered table-hover" border='1' cellpadding='5' cellspacing='0' width='1000'>
					<tr>
						<td bgcolor="lightblue">編號:<font color=red><b>*</b></font></td>
				...
				<%-- 		<td><input type="TEXT" name="stroke_no" size="45"	value="<%=actVO.getStroke_no()%>" /></td> --%>
					...
					<tr>
						...
						<td bgcolor="#FFC78E">
						<textarea rows="6" cols="500"  id="myTextarea" name="act_exp" >${(actVO.act_exp==null or actVO.act_exp=="" or actVO.act_exp=="null")? "請輸入" : actVO.act_exp }
						</textarea>
						</td>
					</tr>
					<tr>
