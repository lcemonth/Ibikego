...
<link rel="stylesheet" href="<%=request.getContextPath()%>/back-end/questionsanswers//js/ckeditor/contents.css">
...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/que_ans.do?action=update_back" name="form1">
	<table border="0">
		
		<tr>
			<td>Q&A問題:	<td><input type="TEXT" name="que_ans_q" size="45" value="<%=que_ansVO.getQue_ans_q()%>" /></td></td>
			...
			<form id="content" method="post">
				...
				<a id="v0" class="various" href="javascript:void(0)"><img width="30" src="<%=request.getContextPath()%>/back-end/questionsanswers/images/image.png" title="插入圖片"></a>
				<textarea class="ckeditor" id="content" rows="6" cols="35"
				name="que_ans_a" value="${que_ansVO.que_ans_a}">${que_ansVO.que_ans_a}</textarea>
			</form>
			</td>
		</tr>
	</table>
